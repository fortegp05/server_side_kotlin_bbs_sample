...
class ArticleControllerTests {
    ...
    fun updateArticleNotExistsArticleTest() {
        ...
        .andExpect(flash().attribute<String>("alert_class", "alert-error"))
    }
    ...
    fun updateArticleExistsArticleTest() {
        ...
        .andExpect(flash().attributeExists<String>("message"))
        .andExpect(flash().attributeExists<String>("alert_class"))
        .andExpect(flash().attribute<String>("alert_class", "alert-success"))
    }
    ...
    fun getDeleteConfirmExistsIdTest() {
        ...
        mockMvc.perform(
                get("/delete/confirm/${latestArticle.id.toString()}")
        )
        .andExpect(status().isOk)
